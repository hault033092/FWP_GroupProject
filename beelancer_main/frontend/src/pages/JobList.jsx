        ...
        return (
            <Card className="card" sx={{ mb: 3 }}>
                <CardHeader
                    ...
                    title={
                        <Typography className="header__company">
                            Microsoft
                        </Typography>
                    }
                    subheader={
                            ...
                            >
                                <CardContent>
                                    <Typography
                                        ...
                                        gutterBottom
                                    >
                                        Do you know a prospective candidate to
                                        recommend?
                                    </Typography>
                                    <Typography
                                        color="white"
                                        ...
                                        component="div"
                                    >
                                        Refer him to us and recevie a reward
                                        when he accepts an offert
                                    </Typography>
                                </CardContent>
                                <CardActions sx={{ mt: 5 }}>
                                    <Button
                                        variant="contained"
                                        className="suggest__friend"
                                    >
                                        Suggest a friend
                                    </Button>
                                </CardActions>
